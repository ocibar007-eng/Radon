...
const App: React.FC = () => {
    ...
    const themeClasses = isDarkMode
        ? 'min-h-screen bg-zinc-950 font-sans text-zinc-100 selection:bg-white selection:text-black antialiased flex flex-col'
    ...
    return (
        <div className={themeClasses}>
            ...
            {/* Modern Header */}
            <header className={`sticky top-0 z-20 backdrop-blur-xl border-b ${isDarkMode ? 'bg-gradient-to-r from-zinc-950/95 to-zinc-900/95 border-zinc-800' : 'bg-gradient-to-r from-white/95 to-zinc-50/95 border-zinc-200'}`}>
            ...
            <main className="flex-1 max-w-[1600px] mx-auto w-full grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-0">
                        ...
                        <section className={`p-6 rounded-2xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border relative overflow-hidden group ${isDarkMode ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-zinc-100'}`}>
                            ...
                            <div className="space-y-3 relative z-10">
                                ...
                                <button
                                    ...
                                    disabled={files.length === 0}
                                    className={`w-full py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2 border transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm ${isDarkMode ? 'bg-zinc-800 text-zinc-300 border-zinc-700 hover:bg-zinc-700' : 'bg-white text-zinc-600 border-zinc-200 hover:bg-zinc-50 hover:border-zinc-300'}`}
                                >
