...
export async function localizeRecommendationsToPtGemini(
  ...
  try {
    ...
    const response = await generate(CONFIG.MODEL_NAME, {
      ...
      config: {
        ...
        thinkingConfig: { thinkingBudget: CONFIG.FAST_MODE_THINKING_BUDGET },
      },
    });
    ...
    console.warn('[RecommendationLocalizerGemini] Failed to translate recommendations:', error);
    return recommendations;
  }
}
